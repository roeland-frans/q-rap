...
struct tMeasNN
{
	...
	double 		sEIRP;
	double 		sSiteDir; 						// Direction of Neighbour with respect to serving site; 0 if same site
	double 		sSiteDist;						// Distance of neighbour site from serving site;
	double		sAntAzi;						// Azimuth direction of this neighbour cell antenna; 0 if beamwidth = 360 degrees
	double		sAntBW;						// Horizontal Beamwidth of this neigbour cell antenna
};
