...
#ifndef cMeasImportSpace_h
#define cMeasImportSpace_h 1
...
{
   public:
	cMeasImportSpace(); // default constructor
	~cMeasImportSpace(); // destructor

	cMeasImportSpace(double Sensitivity,
			double Frequency,
			unsigned CI, 
			unsigned MeasType, 
			unsigned MeasSource, 
